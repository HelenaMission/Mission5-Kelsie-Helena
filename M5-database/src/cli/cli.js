...
program.command('deleteProperty').description('Delete property database').action(deletePropertyCmd);

program.command('deleteService').description('Delete service database').action(deleteServiceCmd);

program.command('deleteReview').description('Delete review database').action(deleteReviewCmd);
