      ...
      <div className="h-auto pb-36">
        ...
        <button
          ...
          className={`w-[220px] h-[60px] ${
            isButtonClicked
              ? "bg-slate-200 text-rose-600 ease-linear"
        ...
        <div
          className={`line relative top-[69px] w-auto h-[3px] ${
            isButtonClicked ? "bg-slate-200" : "bg-red-600"
          }`}
        ></div>
        <div
        ...
        <div
          className={`relative top-[85px] pt-12 flex justify-center ${
